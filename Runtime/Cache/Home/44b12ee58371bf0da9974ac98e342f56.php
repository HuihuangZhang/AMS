...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/AM/Public/css/ms/FreeTimeForm.css">
		...
		<script type="text/javascript" src="/AM/Public/js/ms/FreeTimeForm.js"></script>	
	</head>
	<body>
		<div class="container-fluid">
			<div class="navigationbar">
			    ...
			    <?php if(I('cookie.type') == 1): ?><li role="presentation" id="gr"><a href="javascript:void(0)">个人信息管理</a></li>
			        <li role="presentation" class="active" id="dj"><a href="javascript:void(0)">登记空闲时间</a></li>
			...
			<div class="content">
				<div id="FreeTimeForm">
					<form action="" method="get">
						...
						<div class="save">
				  		<button class="btn btn-lg btn-primary btn-block" id="savefreetime" type="button">保存</button>
						</div>
					</form>
				</div>
			</div><!-- content -->
